-- =====================================================================
-- PERRONES — Reseñas moderadas (aplicar cuando el deploy esté READY).
-- Pega TODO en Supabase → SQL Editor → Run. Es independiente de las
-- migraciones 0014-0016 que ya corriste.
-- =====================================================================
