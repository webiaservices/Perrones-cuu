-- =====================================================================
-- PERRONES — Recurrencia (semanal/una vez) y raza del perro
-- ⚠️ CORRER ESTO **ANTES** DE QUE SE SUBA EL CÓDIGO NUEVO.
-- Solo agrega columnas: no rompe nada de lo que ya está funcionando.
-- =====================================================================
